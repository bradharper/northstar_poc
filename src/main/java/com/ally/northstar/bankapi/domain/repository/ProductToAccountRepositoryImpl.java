 ...
 */
@Component
public class ProductToAccountRepositoryImpl extends RelationshipRepositoryBase<Product, Long, Account, Long> {

	public ProductToAccountRepositoryImpl() {
		super(Product.class, Account.class);
	}
}
